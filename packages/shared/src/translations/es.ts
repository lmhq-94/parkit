export const es = {
  ...
  common: {
    ...
    'common.occupied': 'Ocupados',
    'common.reserved': 'Reservados',
    ...
    'common.rates': 'Tarifas',
    'common.schedule': 'Horario',
    'common.start': 'Inicio',
    'common.end': 'Fin',
    'common.appName': 'Parkit',
    'common.appDescription': 'Sistema de Gestión de Parqueos',
    'common.all': 'Todos',
  ...
  navigation: {
    ...
    'navigation.parkings': 'Parqueos',
    'navigation.reservations': 'Reservas',
    'navigation.vehicles': 'Vehículos',
    'navigation.payments': 'Pagos',
    'navigation.events': 'Eventos',
    'navigation.qrScanner': 'Escanear QR',
    'navigation.reports': 'Reportes',
    'navigation.goToDashboard': 'Ir al Dashboard',
  },
  ...
  auth: {
    ...
    'auth.useTestCredentials': 'Usar Credenciales de Prueba',
    'auth.testCredentials': 'Credenciales de prueba',
    'auth.testEmail': 'Email: admin@techcorp.com',
    'auth.testPassword': 'Contraseña: admin123',
  ...
  dashboard: {
    ...
    'dashboard.managementPanel': 'Panel de Gestión',
  ...
  parkings: {
    ...
    'parkings.title': 'Gestión de Parqueos',
    'parkings.noResults':
      'No se encontraron parqueos con los filtros aplicados',
    'parkings.searchPlaceholder': 'Buscar parqueos...',
    'parkings.addParking': 'Add Parking',
  },
  ...
  reservations: {
    ...
    'reservations.title': 'Gestión de Reservas',
    'reservations.noResults':
      'No se encontraron reservas con los filtros aplicados',
    'reservations.newReservation': 'Nueva Reserva',
    'reservations.searchPlaceholder': 'Buscar reservas...',
  },
  ...
  vehicles: {
    ...
    brands: {
      ...
      'vehicles.vin': 'VIN',
      'vehicles.title': 'Gestión de Vehículos',
      'vehicles.brands.toyota': 'Toyota',
      'vehicles.brands.honda': 'Honda',
      'vehicles.brands.ford': 'Ford',
      'vehicles.brands.nissan': 'Nissan',
      'vehicles.models.corolla': 'Corolla',
      'vehicles.models.civic': 'Civic',
      'vehicles.models.focus': 'Focus',
      'vehicles.models.sentra': 'Sentra',
      'vehicles.colors.white': 'Blanco',
      'vehicles.colors.black': 'Negro',
      'vehicles.colors.blue': 'Azul',
      'vehicles.colors.gray': 'Gris',
      'vehicles.noResults':
  ...
  events: {
    ...
    eventTypes: {
      ...
      'events.registerEvent': 'Registrar Evento',
      'events.eventType': 'Tipo de Evento',
      'events.entry': 'Entrada',
      'events.exit': 'Salida',
      'events.title': 'Gestión de Eventos',
      'events.recentEvents': 'Eventos Recientes',
      'events.manualEventRegistered': 'Evento registrado manualmente',
      'events.noRecentEvents': 'No hay eventos recientes para mostrar',
      'events.eventTypeLabel': 'Event Type:',
    },
  },
  ...
  qrScanner: {
    ...
    'qrScanner.qrCode': 'Código QR',
    'qrScanner.title': 'Escáner de Código QR',
    'qrScanner.manualEntry': 'Entrada Manual',
    'qrScanner.cameraDescription':
      'Usa la cámara para escanear códigos QR de parqueos o vehículos',
    'qrScanner.manualDescription':
      'Ingresa el código manualmente si no puedes escanear',
    'qrScanner.exampleCode': 'Ej: PARKIT_QR_001',
    'qrScanner.scanQR': 'Scan QR',
    'qrScanner.scannerIcon': '📱',
  },
  ...
  settings: {
    ...
    'settings.reservationReminders': 'Recordatorios de reservas',
    'settings.activeSessions': 'Sesiones activas',
    'settings.twoFactorAuth': 'Autenticación de dos factores',
    'settings.loginNotifications': 'Notificaciones de inicio de sesión',
    'settings.description':
      'Configura tus preferencias de idioma, tema y notificaciones',
  ...
  errors: {
    ...
    'errors.insufficientPermissions': 'Permisos Insuficientes',
    'errors.noPageAccess': 'No tienes permisos para acceder a esta página',
    'errors.noFeatureAccess':
      'No tienes los permisos necesarios para acceder a esta funcionalidad',
    'errors.currentRole': 'Tu rol actual',
  },
